...
description: "Install official tidas 0.2.0 and check the platform, checksum, and command path."
---

Use the prebuilt executables from the [official v0.2.0 release](https://github.com/tiangong-lca/tidas-tools/releases/tag/v0.2.0). The installers download the fixed platform archive and its `.sha256`, then install only after verification. You may download and inspect the script before running it.
